...
export const AgentSwarmToolInputSchema = z
  .object({
    ...
    thinking_level: z
      ...
      .optional()
      .describe(
        'Optional thinking effort level for all subagents spawned in this swarm ("off", "low", "medium", "high", "xhigh", "max"). Resumed subagents always keep their own thinking level.',
      ),
    model: z
      .string()
      .trim()
